...
class Label:
    def __init__(self, rect, rect_color, text, font_color, center=True, hidden=False):
...
class Button(Label):
    def __init__(self, rect, rect_color, text, font_color, center=True):
        super().__init__(rect, rect_color, text, font_color, center)
        self.pressed = False
    ...
    def render(self, surface):
        ...
        if not self.pressed:
            ...
            if self.center:
                self.rendered_rect = self.rendered_text.get_rect(center=(self.rect.centerx + 2, self.rect.centery + 2))
            else:
...
class ImageButton:
    def __init__(self, rect, rect_color, image, center=True):
        self.rect = pygame.Rect(rect)
        self.rect_color = rect_color
        self.image = image
        self.center = center
...
class TextBox(Label):
    def __init__(self, rect, rect_color, font_color, max_len=-1):
        super().__init__(rect, rect_color, "", font_color, center=False)
...
class Checkbox(Button):
    def __init__(self, rect, rect_color, font_color, center=True):
        super().__init__(rect, rect_color, "", font_color, center=center)
        self.text = "+" if self.pressed else "-"
